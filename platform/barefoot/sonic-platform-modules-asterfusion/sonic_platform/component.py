...
class Component(ComponentBase):
    ...
    def __init__(self, component_index, helper, bdid, device, platform):
        ...
        # Init index
        self._component_index = component_index + 1
    ...
    def _init_component_info(self):
        ...
        self._api_helper.log_debug(
            "Retrieved information of component {}".format(self.get_name())
        )
