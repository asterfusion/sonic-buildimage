...
class Sff8472MemMap(XcvrMemMap):
    def __init__(self, codes):
        ...
        self.SERIAL_ID = RegGroupField(consts.SERIAL_ID_FIELD,
            ...
            CodeRegField(consts.EXT_SPEC_COMPLIANCE_FIELD, self.get_addr(0xA0, 0, 36), self.codes.EXT_SPEC_COMPLIANCE),
            ...
            size=2, format="<H"),
            NumberRegField(consts.SIGNALING_RATE_FIELD, self.get_addr(0xA0, None, 66)),
        ...
        self.ADDITIONAL_ENHANCED_FEATURES = RegGroupField(consts.ADDITIONAL_ENHANCED_FEATURES_FIELD,
            CodeRegField(consts.SECOND_EXT_SPEC_COMPLIANCE_FIELD, self.get_addr(0xA2, 0, 67), self.codes.EXT_SPEC_COMPLIANCE),
        )
