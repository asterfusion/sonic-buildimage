...
class Sff8636Api(XcvrApi):
    ...
    def get_transceiver_info(self):
        ...
        xcvr_info = {
            ...
            "signaling_rate": serial_id[consts.SIGNALING_RATE_FIELD],
    ...
    def get_tx_power_support(self):
        if self.is_copper():
            return False
        if self._tx_power_support is None:
            ...
            if rev_compliance == Sff8636Codes.REV_COMPLIANCE[8]:
                self._tx_power_support = self.xcvr_eeprom.read(consts.TX_POWER_SUPPORT_FIELD)
            else:
                self._tx_power_support = True
        # Asterfusion fix: temporarily forcely enable support for tx power. To be removed later.
        self._tx_power_support = True
        return self._tx_power_support
    ...
    def get_temperature_support(self):
        ...
        # Asterfusion fix: temporarily forcely enable support for temperature. To be removed later.
        self._temp_support = True
    ...
    def get_voltage_support(self):
        ...
        # Asterfusion fix: temporarily forcely enable support for voltage. To be removed later.
        self._voltage_support = True
